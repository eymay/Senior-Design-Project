...
\end{textblock}
\vspace*{20mm}
\textbf{\makebox[4cm]{Name Surname}\makebox[1.6cm]{\hfill \textbf{:}}}\hspace{0.225em} Emrecan Yiğit \\ % Adjust the colomn alignment - SBÖ

\textbf{Place and Date of Birth\makebox[0.735cm]{\hfill \textbf{:}}}\hspace{0.225em} Istanbul / 06.05.2002  \\ % Adjust the colomn alignment - SBÖ

\textbf{E-Mail\makebox[3.685cm]{\hfill \textbf{:}}}\hspace{0.225em} emrecanyigit11@gmail.com \\ % Adjust the colomn alignment - SBÖ
