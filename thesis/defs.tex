...
\usepackage{hhline} 			% If desired to eliminate hline in tables - SBÖ
\usepackage{siunitx}
%\usepackage{ragged2e}
\usepackage[document]{ragged2e} % Justfying the text - SBÖ
\usepackage{tabularx} 
\usepackage{pgfgantt} 			% Gantt Chart package for thesis time schedule - SBÖ
...
%\DeclareCaptionListFormat{subfigure}{\arabic{chapter}.\arabic{chap
...
\renewcommand{\eqref}[1]{\textup{\bf(\ref{#1})}} % All bold in eq. referencing incl. parentheses - SBÖ
\makeatother
