; ModuleID = 'LXR.c'
source_filename = "LXR.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-unknown-linux-gnu"

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define dso_local void @lxr(ptr nocapture noundef %ptr) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr %ptr, align 4, !tbaa !7
  %not = xor i32 %0, -1
  store i32 %not, ptr %ptr, align 4, !tbaa !7
  ret void
}
...
!6 = !{!"clang version 17.0.0 (https://github.com/llvm/llvm-project.git 07158c54add927057690aa8c073d35d42eac7006)"}
!7 = !{!8, !8, i64 0}
!8 = !{!"int", !9, i64 0}
