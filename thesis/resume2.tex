...
\begin{textblock}{1}(39,15.75) % Photo is adusted flush to the right margin - SBÖ
	\begin{figure}[p]
...
\end{textblock}
\vspace*{20mm}
\textbf{\makebox[4cm]{Name Surname}\makebox[1.6cm]{\hfill \textbf{:}}}\hspace{0.225em} Bora İnan \\ % Adjust the colomn alignment - SBÖ

\textbf{Place and Date of Birth\makebox[0.735cm]{\hfill \textbf{:}}}\hspace{0.225em} Istanbul / 07.02.2000\\ % Adjust the colomn alignment - SBÖ

\textbf{E-Mail\makebox[3.685cm]{\hfill \textbf{:}}}\hspace{0.225em} borainan0@gmail.com\\ % Adjust the colomn alignment - SBÖ
