...
%TODO make sure Zba is explained for SH1ADD instr, https://wiki.riscv.org/display/HOME/Recently+Ratified+Extensions, https://github.com/riscv/riscv-crypto/releases/tag/v1.0.1-scalar
