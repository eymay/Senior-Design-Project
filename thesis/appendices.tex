...
Clang is the C compiler front-end which is mainly used with LLVM back-end. Clang is used in this project to produce LLVM IR code. Following command produces a .ll file in the current directory. 
